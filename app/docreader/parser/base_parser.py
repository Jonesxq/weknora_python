...
class BaseParser(ABC):
    ...
    BaseParser only extracts markdown text and raw image references from
    documents. Chunking, image storage, OCR, and VLM caption belong to the
    Python RAG ingestion layer.
    """
